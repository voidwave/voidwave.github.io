const desktopLanguage = (() => {
    const arabic = {
        ...
        'Arabic Matrix': 'ماتريكس عربي',
        'Otherworld': 'عالم آخر',
        'Graphite': 'جرافيت',
        'Blue Sanctuary': 'الملاذ الأزرق',
        'Solar Mosque': 'مسجد الشمس',
        'Moonlit Domes': 'قباب تحت ضوء القمر',
        'Ivory Pyramids': 'أهرامات عاجية',
        'Emerald Sky': 'سماء زمردية',
        'Sunset Minarets': 'مآذن الغروب',
        'Crimson Monument': 'صرح قرمزي',
        'Autumn Ruins': 'أطلال الخريف',
